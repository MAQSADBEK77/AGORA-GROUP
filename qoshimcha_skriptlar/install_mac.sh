...
echo "  1. ./start_backend_mac.sh  (backend)"
echo "  2. ./start_frontend_mac.sh (frontend)"
echo "  (yoki repo tub papkasidagi Backend_Mac.command va"
echo "   Frontend_Mac.command fayllarini ikki marta bosing)"
echo "================================================"
